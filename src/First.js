...
import usasa from "./assets/usasa.jpg";
    ...
    return (
      <div>
        ...
        <div className='fam'>
          ...
          <div className='cont1 '>
            <label><h2>If you can dream,we can create it</h2></label>
            </div>
            <div className='cont2'>
            <label><h1>Find your house without any difficulties</h1></label>
            </div>

            
            <div>
            <button  className='btn btn-outline-info'>Know More</button>
            </div>
      ...
      <div className='hs'>
        ...
        <div className='build'>
          ...
          <div>
          < label>94-98 Ingraham St,Brooklyn, NY 11237,USA</label>
          </div><br/><br></br>
        ...
        <div className='fle'>
         ...
         <h1> <p>as power as it is</p> </h1>
          ...
          <div className='ent'>
             <img src={sundar} width="600" height="500"></img>
         </div>
           </div>
           <div className='lorel'>
       ...
       <div className='beach2'>
         <img src={beach} width='470' height='700'></img>
         </div>
         <div className='usas2'>
         <img src={usa} width='360' height='300'></img>
         </div>
         <div className='hou2'>
         <img src={hou} width='350' height='300'></img>
         </div>
         <div className='smar2'>
         <img src={usasa} width='350' height='300'></img>
         </div>
         <div className='dream2'>
         <img src={dream} width='350' height='300'></img>
         </div>
         </div>
